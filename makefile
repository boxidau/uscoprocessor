...
LIBS_SHARED_BASE := C:\Users\simon\OneDrive\Documents\Arduino\libraries
...
FLAGS_LD    := -Wl,--print-memory-usage,--gc-sections,--relax,--defsym=__rtc_localtime=$(shell powershell [int](Get-Date -UFormat +%s)[0]) -T$(CORE_BASE)/mk64fx512.ld
